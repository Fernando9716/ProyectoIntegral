...
public class Login extends javax.swing.JFrame {
   ...
   this.dispose();        // TODO add your handling code here:
    ...
    private void aceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aceptarMouseClicked
        ...
        }else if(user.equals("mesero")&& password.equals("1234")){
            Login.this.dispose();
            MesasVentana m = new MesasVentana();
            m.setVisible(true);
        }else if(user.equals("cocinero")&& password.equals("12345")){
             
 Login.this.dispose();
              VistaRecepcionOrdenes ventaRecepcion = new VistaRecepcionOrdenes();
